...
class MerchantProductModel extends CI_Model
{
	...
	var $column_order = array(
		'prod_name', 'prod_urlname', 'prod_preacher', 'prod_church', 'prod_image', 'img_link', 'prod_tags', 'prod_description',
		...
		'prod_uid', 'prod_type', 'type_list', 'file_link', 'merchant_email', 'currency', null
